...
func (a *App) Menu() *menu.Menu {
	...
	fileMenu.AddText("Choose Version...", keys.CmdOrCtrl("D"), menuCallbackEmit(a, "app:modal", "version"))
	fileMenu.AddText("Choose Text...", keys.CmdOrCtrl("T"), menuCallbackEmit(a, "app:modal", "text"))
	fileMenu.AddSeparator()
	fileMenu.AddText("Functions", keys.CmdOrCtrl("E"), menuCallbackEmit(a, "app:modal", "functions"))
	fileMenu.AddText("Appearence", keys.CmdOrCtrl("R"), menuCallbackEmit(a, "app:modal", "appearence"))
	fileMenu.AddSeparator()
	fileMenu.AddText("Sidebar", keys.CmdOrCtrl("\\"), menuCallbackEmit(a, "app:sidebar:toggle"))
	fileMenu.AddSeparator()
	fileMenu.AddText("Theme toggle", keys.CmdOrCtrl("L"), menuCallbackEmit(a, "graphe:theme:toggle"))
