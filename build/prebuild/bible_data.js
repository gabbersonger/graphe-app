export const bibleData = [
  ...
  },
  {
    ...
    superscripts: [
      ...
      109, 110, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132,
  ...
  // TODO: figure out how to handle LXX parallels...
  // { book_number: 82, name: "Joshua (Parallel)" }, // 15:62, 18:28, 19:45
  // { book_number: 83, name: "Judges (Parallel)" }, // 1:36, 2:23, 3:31, 4:24, 5:31, 6:40, 7:25, 8:35, 9:57, 10:18, 11:40, 12:15, 13:25, 14:20, 15:20, 16:31, 17:13, 18:31, 19:30, 20:48, 21:25,
  // { book_number: 84, name: "Tobit (Parallel)" }, // 1:22, 2:14, 3:17, 4:21, 5:23, 6:19, 7:17, 8:21, 9:6, 10:14, 11:19, 12:22, 13:18, 14:15,
  // { book_number: 85, name: "Daniel (Parallel)" }, // 1:21, 2:49, 3:97, 4:37, 5:30, 6:29, 7:28, 8:27, 9:27, 10:21, 11:45, 12:13,
  // { book_number: 86, name: "Susanna (Parallel)" }, // 1:64
  // { book_number: 87, name: "Bel and the Dragon (Parallel)" }, // 1:42
];
...
export const versionData = {
  ...
  lxx: {
    ...
    books: [
      ...
      // TODO: figure out how to handle parallels...
      // { book_number: 82, name: "Joshua (Parallel)" },
      // { book_number: 83, name: "Judges (Parallel)" },
      // { book_number: 84, name: "Tobit (Parallel)" },
      // { book_number: 85, name: "Daniel (Parallel)" },
      // { book_number: 86, name: "Susanna (Parallel)" },
      // { book_number: 87, name: "Bel and the Dragon (Parallel)" },
    ],
  },
  gnt: {
